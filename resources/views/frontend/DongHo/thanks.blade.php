...
<head>
    ...
    <meta name="description" content="Cảm ơn Đồng Hồ">
    ...
    <link rel="canonical" href="http://camondongho.demopage.me"/>
    <meta property="og:url" content="http://camondongho.demopage.me"/>
    <meta property="og:title" content="Đặt tiêu đề trang"/>
    <meta property="og:type" content="website"/>
    <meta property="og:image" content="https://static.ladipage.net/57b167c9ca57d39c18a1c57c/untitled-1-649824.jpg">
    <meta property="og:description" content="Cảm ơn Đồng Hồ"/>
    ...
    <link rel="preload"
          href="https://fonts.googleapis.com/css?family=Open Sans:bold,regular|Tinos:bold,regular|Roboto:bold,regular&display=swap"
          as="style" onload="this.onload = null;this.rel = 'stylesheet';">
    <link rel="preload" href="https://w.ladicdn.com/v2/source/ladipage.min.js?v=1576738683613" as="script">
    <style id="style_ladi"
    ...
    <style id="style_page" type="text/css">.ladi-wraper {
            margin: 0 auto;
            width: 420px;
        }
    ...
    <style id="style_element" type="text/css">#SECTION_POPUP {
        ...
        #IMAGE21 > .ladi-image > .ladi-image-background {
            ...
            width: 83px;
            height: 101px;
            background-image: url("https://w.ladicdn.com/s400x450/57b167c9ca57d39c18a1c57c/icon-gio-hang.png");
        }
        ...
        #IMAGE23 > .ladi-image > .ladi-image-background {
            ...
            width: 411.6px;
            height: 49px;
            background-image: url("https://w.ladicdn.com/s750x350/57b167c9ca57d39c18a1c57c/ribbon-554440.png");
        }
        ...
        #IMAGE27 > .ladi-image > .ladi-image-background {
            ...
            width: 144.285px;
            height: 144px;
            background-image: url("https://w.ladicdn.com/s450x450/57b167c9ca57d39c18a1c57c/best-choice.png");
        }
...
<div class="ladi-wraper">
    <div id="SECTION2" class="ladi-section">
        ...
        <div class="ladi-container">
            <div style="padding: 0px 10px;" id="HEADLINE19" class="ladi-element"><h2 class='ladi-headline'>
                    Nhân viên bán hàng sẽ liên hệ đến bạn để tư vấn và gửi sản phẩm đến bạn trong thời gian sớm nhất!.<br><br>
                    Đơn hàng sẽ đến tay bạn từ 2-7 ngày.<br><br>
                    Khi bưu tá giao hàng bạn nhớ nhận hàng nha.<br>&nbsp;</h2></div>
            <div id="HEADLINE20" class="ladi-element"><h1 class='ladi-headline'>ĐẶT HÀNG HOÀN TẤT</h1></div>
            ...
            <div id="GROUP38" class="ladi-element">
                <div class='ladi-group'>
                    ...
                    <div id="HEADLINE24" class="ladi-element"><h5 class='ladi-headline'>Tiktok đảm bảo hàng
                            chuẩn<br><br></h5></div>
                </div>
            </div>
...
<script src="https://w.ladicdn.com/v2/source/respond.min.js?v=1576738683613"></script><![endif]-->
<link href="https://fonts.googleapis.com/css?family=Open Sans:bold,regular|Tinos:bold,regular|Roboto:bold,regular&display=swap"
      rel="stylesheet" type="text/css">
<link href="{{ asset('css/frontend/ladi/ladipage.min.css') }}" rel="stylesheet" type="text/css">
<script src="{{ asset('css/frontend/ladi/ladipage.min.js') }}" type="text/javascript"></script>
<script id="script_event_data" type="text/javascript">(function () {
        var run = function () {
            ...
            window.LadiPageScript.runtime.ladipage_id = '5de8df71fcfbb916fb282310';
