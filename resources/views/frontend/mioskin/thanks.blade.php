...
<head>
    ...
    <link rel="canonical" href="http://sacnamchamphatsang.phukienonline.com.vn/cam-on"/>
    <meta property="og:url" content="http://sacnamchamphatsang.phukienonline.com.vn/cam-on"/>
    <meta property="og:title" content="Đặt tiêu đề trang"/>
    <meta property="og:type" content="website"/>
    <meta property="og:image" content="https://static.ladipage.net//57b167c9ca57d39c18a1c57c/untitled-1-015086.jpg">
    <meta property="og:description" content="Cảm ơn"/>
    ...
    <link rel="preload" href="https://w.ladicdn.com/v2/source/ladipage.min.js?v=1582173317226" as="script">
    <style id="style_ladi"
        ...
        .ladi-add-to-cart-detail .add-to-cart-detail-quantity input::-webkit-inner-spin-button, .ladi-add-to-cart-detail .add-to-cart-detail-quantity input::-webkit-outer-spin-button {
            -webkit-appearance: none;
            margin: 0
        }
    ...
    <style id="style_element" type="text/css">@media (min-width: 768px) {
            ...
            #IMAGE6 > .ladi-image > .ladi-image-background {
                ...
                top: 0px;
                left: 0px;
                background-image: url("https://mioskin.com.vn/xit-duong-te-bao-goc/wp-content/uploads/2019/11/Mioskin-2.png");
            }
    ...
    <script>
        (function() {
            ...
            ta.src = document.location.protocol + '//' + 'static.bytedance.com/pixel/sdk.js?sdkid=BP93L5VJIRDMQJBTKQG0';
...
<div class="ladi-wraper">
    <div id="SECTION2" class="ladi-section">
        ...
        <div class="ladi-container">
            <div id="HEADLINE3" class="ladi-element"><h1 class='ladi-headline'>Cảm ơn bạn đã đăng ký mua sản phẩm!</h1>
            </div>
            ...
            <div id="PARAGRAPH7" class="ladi-element"><p style="font-size: 20px;" class='ladi-paragraph'>Bạn đã đặt hàng thành công, nhân viên
                    bán hàng sẽ liên hệ đến bạn để tư vấn và gửi sản phẩm đến bạn trong thời gian sớm nhất!</div>
...
<!--[if lt IE 9]>
<script src="https://w.ladicdn.com/v2/source/html5shiv.min.js?v=1582173317226"></script>
<script src="https://w.ladicdn.com/v2/source/respond.min.js?v=1582173317226"></script><![endif]-->
<link href="https://fonts.googleapis.com/css?family=Open Sans:bold,regular|Roboto Slab:bold,regular|Roboto:bold,regular&display=swap"
...
<script id="script_event_data" type="text/javascript">(function () {
        var run = function () {
            ...
            window.LadiPageScript.runtime.ladipage_id = '5e4f92a2f4a6442c5ac5f1fc';
            window.LadiPageScript.runtime.isMobileOnly = false;
            window.LadiPageScript.runtime.DOMAIN_SET_COOKIE = ["phukienonline.com.vn"];
