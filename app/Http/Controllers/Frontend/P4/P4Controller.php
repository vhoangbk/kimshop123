...
namespace App\Http\Controllers\Frontend\P4;
...
class P4Controller extends Controller
{
    ...
    public function index(Request $request){
        return view('frontend.p4.index');
    }

    public function thanks(Request $request){
        return view('frontend.p4.thanks');
    }
    ...
    public function addCustomer(Request $request)
    {
        ...
        if ($cus == null) {
            ...
            $pro = $this->promotionRepository->findBy("code", "loa-bluetooth-karaoke");
