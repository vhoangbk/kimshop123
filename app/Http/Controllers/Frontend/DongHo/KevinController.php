...
namespace App\Http\Controllers\Frontend\DongHo;
...
class KevinController extends Controller
{
    ...
    public function index(Request $request){
        return view('frontend.dongho.index');
    }

    public function thanks(Request $request){
        return view('frontend.dongho.thanks');
    }
    ...
    public function addCustomer(Request $request)
    {
        ...
        if ($cus == null) {
            ...
            $pro = $this->promotionRepository->findBy("code", "kevin-watch");
