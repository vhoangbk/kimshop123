...
namespace App\Http\Controllers\Frontend\KhanSay;
...
class KhanSayController extends Controller
{
    ...
    public function index(Request $request){
        return view('frontend.khansay.index');
    }

    public function thanks(Request $request){
        return view('frontend.khansay.thanks');
    }
    ...
    public function addCustomer(Request $request)
    {
        ...
        if ($cus == null) {
            ...
            $pro = $this->promotionRepository->findBy("code", "khan-say-nano");
