...
namespace App\Http\Controllers\Frontend\Cable;
...
class CableController extends Controller
{
    ...
    public function index(Request $request){
        return view('frontend.cable.index');
    }

    public function index2(Request $request){
        return view('frontend.cable.index2');
    }

    public function thanks(Request $request){
        return view('frontend.cable.thanks');
    }

    public function thanks2(Request $request){
        return view('frontend.cable.thanks2');
    }
    ...
    public function addCustomer(Request $request)
    {
        ...
        if ($cus == null) {
            ...
            $pro = $this->promotionRepository->findBy("code", "cable");
